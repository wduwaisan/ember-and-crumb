...
I18N.extend({
  ...
  'h.lede':         ['A roastery and a bakehouse sharing one small building. Buy the beans and the good flour — or describe a drink, a cake or a cookie that has never existed, and watch our baristas and bakers build it.',
                     'محمصة ومخبز يتقاسمان مبنى صغيراً واحداً. اشترِ البن والدقيق الجيد، أو صِف مشروباً أو كيكة أو كوكيز لم توجد من قبل، وشاهد فريقنا يصنعها.'],
  ...
  'h.st.lede':      ['Most menus ask you to pick a row. Ours lets you build one. Choose a base, a milk, the syrups and the strength — stack a cake layer by layer — or ice a cookie with your own words in the font you want. It draws itself as you go, prices itself as you go, and lands on the pass as a recipe card our team actually follows.',
                     'أغلب القوائم تطلب منك اختيار سطر. قائمتنا تدعك تصنع سطراً. اختر القاعدة والحليب والشراب والقوة، أو ابنِ الكيك طبقة طبقة، أو زيّن كوكيز بكلماتك وبالخط الذي تريده. يُرسم أمامك ويُسعّر أمامك، ويصل إلى المطبخ كبطاقة وصفة يتبعها فريقنا فعلاً.'],
  'h.st.exTitle':   ['A worked example.', 'مثال عملي.'],
  'h.st.exBody':    ['A tiramisù is really just lady fingers, a soak and a cream. Swap the espresso soak for strawberry powder bloomed with matcha, put matcha mascarpone between the layers, and dust it pink instead of brown. Nobody on our menu had made that. Now it is on the menu, because a guest built it here.',
                     'التيراميسو في جوهره أصابع سيدة ونقع وكريمة. استبدل نقع الإسبريسو ببودرة فراولة منقوعة مع الماتشا، وضع ماسكاربوني الماتشا بين الطبقات، ورشّه وردياً بدل البني. لم يصنع أحد ذلك عندنا من قبل، والآن هو في القائمة لأن ضيفاً صمّمه هنا.'],
  ...
  'h.step1b':       ['Pick a base, a milk, syrups by the pump. Stack sponge, soak and filling. Or ice a cookie and type your words onto it. The preview redraws with every tap — you are looking at the thing, not a form.',
                     'اختر القاعدة والحليب والشراب بالضخّة. ارصف الكيك والنقع والحشوة. أو زيّن كوكيز واكتب كلماتك عليها. المعاينة تُرسم مع كل ضغطة — أنت ترى الشيء نفسه لا استمارة.'],
  'h.step2t':       ['Name it', 'سمّها'],
  'h.step2b':       ['Give it a name and leave a note for whoever is on bar or on cake. Allergies, sweetness, a collection time. Save it to your account and it is waiting next visit.',
                     'أعطها اسماً واترك ملاحظة لمن سيحضّرها. الحساسية، الحلاوة، وقت الاستلام. احفظها في حسابك وستجدها في زيارتك القادمة.'],
  'h.step3t':       ['Order it', 'اطلبها'],
  'h.step3b':       ['It arrives at the counter as a recipe card, not a riddle. Drinks in about six minutes; cakes need forty-eight hours and a little faith.',
                     'تصل إلى الكاونتر كبطاقة وصفة لا كأحجية. المشروبات خلال ست دقائق، والكيك يحتاج ٤٨ ساعة وقليلاً من الثقة.'],
  ...
  'h.quote':        ['“The strawberry matcha tiramisù was invented by a customer on an iPad by the window. Ember & Crumb put it on the permanent menu three weeks later. That is the whole philosophy of the place, right there.”',
                     '«تيراميسو الفراولة والماتشا ابتكرته زبونة على جهاز لوحي بجانب النافذة. وبعد ثلاثة أسابيع صار في القائمة الدائمة. هذه هي فلسفة المكان كلها.»'],
  ...
  'h.comeBody':     ['The roaster runs Tuesdays and Fridays, so the whole street smells like it. Lamination happens in the window because people like to watch. If the morning buns are gone by ten, that is not a marketing tactic — we only make so many.',
                     'المحمصة تعمل الثلاثاء والجمعة فيعبق الشارع كله. والتوريق يتم عند النافذة لأن الناس يحبون المشاهدة. وإن نفدت كعكات الصباح بحلول العاشرة فتلك ليست حيلة تسويقية — نحن نصنع عدداً محدوداً فقط.'],
  ...
  'mo.lede':        ['Every month we take one creation out of the Studio and make it for everybody. If yours gets picked, you drink free for a year and your name goes on the card.',
                     'كل شهر نختار تصميماً واحداً من الاستوديو ونصنعه للجميع. إن اختير تصميمك، تشرب مجاناً لسنة ويُكتب اسمك على البطاقة.'],
